...
// rows = [
//     ["FOREXCOM:DJI", "OANDA:SPX500USD", "OANDA:NAS100USD", "NASDAQ:QQQ", "OANDA:US2000USD", "UKOIL", "COMEX:HGS1!"],
//     ["CRYPTOCAP:BTC.D", "CRYPTOCAP:TOTAL", "GEMINI:BTCUSD", "BINANCE:ETHUSD", "BINANCE:ETHBTC" , "BINANCE:LINKBTC", "BINANCE:DOTBTC"],
//     ["BINANCE:SNXBTC", "BINANCE:AAVEBTC", "BINANCE:GRTBTC", "BINANCE:THETABTC", "BINANCE:VETBTC","BINANCE:YFIBTC", "BINANCE:UNIBTC"],
//     ["TVC:GOLD", "TVC:SILVER", "TVC:GOLDSILVER", "TVC:PLATINUM", "INDEX:DXY", "FX_IDC:USDBRL", "FX_IDC:USDEUR"],
//     ["NASDAQ:RING", "AMEX:GDXJ", "AMEX:SLVP", "AMEX:SILJ", "NYSE:FNV", "NASDAQ:PAAS", "AMEX:UUUU"],
// ]

// rows = [
//     ["FOREXCOM:DJI", "OANDA:SPX500USD", "OANDA:NAS100USD", "NASDAQ:QQQ", "OANDA:US2000USD", "UKOIL"],
//     ["GEMINI:BTCUSD", "CRYPTOCAP:BTC.D", "GEMINI:ETHUSD", "BINANCE:ETHBTC" , "BINANCE:LINKUSD" , "BINANCE:LINKBTC", "BINANCE:YFIUSD"],
//     ["TVC:GOLD", "TVC:SILVER", "TVC:GOLDSILVER", "TVC:PLATINUM", "INDEX:DXY", "FX_IDC:USDBRL", "FX_IDC:USDEUR"],
//     ["NASDAQ:RING", "AMEX:GDXJ", "AMEX:SLVP", "AMEX:SILJ", "NYSE:FNV", "NASDAQ:PAAS", "ASX:QAU"],
//     ["NYSE:FNV", "AMEX:MMX", "TSX:SSL", "NASDAQ:RGLD", "AMEX:MTA", "NYSE:WPM"]
// ]

// rows = [
//     ["FOREXCOM:DJI", "OANDA:SPX500USD", "OANDA:NAS100USD", "NASDAQ:QQQ", "OANDA:US2000USD", "UKOIL", "AMEX:HYG"],
//     ["GEMINI:BTCUSD", "GEMINI:ETHUSD", "BINANCE:ETHBTC" , "BINANCE:YFIUSD" , "BINANCE:UNIUSD" , "BINANCE:RENUSD" , "BINANCE:SNXUSD"],
//     ["TVC:GOLD", "TVC:SILVER", "TVC:GOLDSILVER", "TVC:PLATINUM", "INDEX:DXY", "FX_IDC:USDBRL", "FX_IDC:USDEUR"],
...
// symbols = [
//   ["INDEX:DXY", "FX_IDC:USDBRL", "FX_IDC:USDEUR", "FX_IDC:USDCNY", "FX:USDJPY", "FX_IDC:USDGBP", "NYSE:SPOT"],
